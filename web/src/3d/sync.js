...
function shallowLightEqual(a, b) {
  ...
  // Linear lights: the bar's endpoints (feet and engine).
  if (!arrayEq(a.endpoint_a_ft, b.endpoint_a_ft)) return false;
  if (!arrayEq(a.endpoint_b_ft, b.endpoint_b_ft)) return false;
  if (!arrayEq(a.endpoint_a, b.endpoint_a)) return false;
  if (!arrayEq(a.endpoint_b, b.endpoint_b)) return false;
